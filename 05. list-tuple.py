...
print("Multidimensional array/list")
...
print("Index of color yellow: "+ str(colors.index("green")))                #index() is used to find Index of value in the list

print("Number of times color red is repeated: "+str(colors.count("red")))   #to count the number of times a value is repeated in the list

#tuple is similar to list but its value can't be modified. i.e immutable
